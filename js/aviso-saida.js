...
(function () {
  ...
  function instalarInterceptor() {
    ...
    _loadPageOriginal = window.loadPage;

    window.loadPage = function (pagina) {
      if (!temAlteracoesPendentes()) {
        return _loadPageOriginal(pagina);
      }
      ...
      // Cancela a navegação — usuário fica na tela atual
    };

    window.loadPage._gomAvisoInstalado = true;
  }

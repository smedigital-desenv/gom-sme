  ...
  return [
    '<div class="empresa-card st-orcamento" style="--card-accent: var(--orcamento);">',
      ...
      '<form onsubmit="enviarOrcamentoEmpresa(event,\'' + idJs + '\')" class="row g-2 mt-2 align-items-end">',
        ...
        '<div class="col-md-4"><label class="form-label small fw-bold"><i class="bi bi-paperclip me-1"></i>Anexos do orçamento</label><input class="form-control form-control-sm" type="file" onchange="gomAnexoAcumular(this)" name="anexosOrcamento" multiple accept="image/*,.pdf,.doc,.docx,.xls,.xlsx"></div>',
  ...
  return [
    '<div class="empresa-os-list-row empresa-os-list-row-v2 st-orcamento" style="--card-accent:' + cor + ';">',
      ...
      '<div class="empresa-os-agendamento-wrap" data-label="Anexos do orçamento">',
        ...
        '<input class="form-control form-control-sm" type="file" onchange="gomAnexoAcumular(this)" name="anexosOrcamento" form="' + formId + '" multiple accept="image/*,.pdf,.doc,.docx,.xls,.xlsx">',
      '</div>',
    ...
    '<div class="empresa-gerencial-row ' + classe + '" style="--card-accent:' + cor + ';">',
      ...
      '<div class="empresa-gerencial-acoes" data-label="Ações">',
        ...
        '<form onsubmit="finalizarOsEmpresaFront(event,\'' + idJs + '\')" class="empresa-finaliza-form">',
          ...
          '<input class="form-control form-control-sm" type="file" onchange="gomAnexoAcumular(this)" name="anexosServico" multiple accept="image/*,.pdf,.doc,.docx,.xls,.xlsx">',

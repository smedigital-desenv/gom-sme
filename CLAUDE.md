# GOM — Gestão de Obras e Manutenção
...
Acompanhamento de obras e serviços nas unidades da rede, com acesso de empresas externas (perfil `empresa`). Integrado ao central no modelo "Fase 1": login e menus governados pelo central, dados no Supabase próprio do GOM.

Publicado em `smedigital.com.br/gom-sme/` pelo GitHub Pages.
---
